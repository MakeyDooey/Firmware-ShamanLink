...
#if !defined(LPC55S69_cm33_core0_H_)  /* Check if memory map has not been already included */
#define LPC55S69_cm33_core0_H_
...
#endif  /* #if !defined(LPC55S69_cm33_core0_H_) */
